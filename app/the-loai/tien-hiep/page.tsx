        ...
        <div className="w-full md:max-w-[750px]   m-auto lg:max-w-[1200px]">
          <div className="w-full grid grid-cols-1 py-1 mt-4 gap-5 lg:grid-cols-4">
            ...
            <div className="hidden  lg:block">
              <div className="bg-[#ecf0f1] text-xs flex flex-col gap-3 dark:border-none dark:bg-[#272727] border-[#D9E1E4] border p-3 ">
                <p className="leading-5">
                  Truyện tiên hiệp thường kể về quá trình tu luyện và khám phá
                  thế giới tu sĩ thần tiên đầy bí ẩn của nhân vật chính.
                </p>
                <p className="leading-5">
                  Trong truyện tiên hiệp thường chia ra những cấp bậc tu luyện
                  trước khi thành tiên như sau:
                </p>
                ...
                <p className="leading-5 mb-5">
                  Ngoài ra còn có những cấp độ ngoài tiên như Bán Thánh, Vô Cực
                  Thánh Nhân,.. dựa theo trí tưởng tượng của tác giả.
                </p>
              </div>
