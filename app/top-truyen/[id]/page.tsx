        ...
        <div className="w-full md:max-w-[750px]   m-auto lg:max-w-[1200px]">
          <div className="w-full grid grid-cols-1 py-1 mt-4 gap-5 lg:grid-cols-4">
            ...
            <div className="hidden  lg:block">
              <p className="bg-[#ecf0f1] dark:border-transparent text-sm dark:bg-[#2b2b2b] border-[#D9E1E4] border p-3 "></p>
              <div className="bg-[#ecf0f1] dark:bg-transparent dark:border-transparent border-[#D9E1E4] border  text-base mt-8 p-2 ">
                <ListCategoryHome />
              </div>
